...
START_TEST(s21_add_1) {
  ...
  int return_value = s21_add(value_1, value_2, &end);
...
START_TEST(s21_add_5) {
  ...
  int return_value = s21_add(value_1, value_2, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 0);
...
START_TEST(s21_add_15) {
  ...
  s21_decimal end_origin;
  end_origin.bits[3] = 0x300000;
  end_origin.bits[2] = 0;
  end_origin.bits[1] = 0x10E;
  end_origin.bits[0] = 0xCFC9FEEE;
  s21_decimal end_our;
  s21_add(src1, src2, &end_our);
  ck_assert_int_eq(end_origin.bits[3], end_our.bits[3]);
  ck_assert_int_eq(end_origin.bits[2], end_our.bits[2]);
  ck_assert_int_eq(end_origin.bits[1], end_our.bits[1]);
  ck_assert_int_eq(end_origin.bits[0], end_our.bits[0]);
}
END_TEST
...
START_TEST(s21_add_16) {
  ...
  s21_decimal end_origin;
  end_origin.bits[3] = 0x80070000;
  end_origin.bits[2] = 0;
  end_origin.bits[1] = 0x270FEFED;
  end_origin.bits[0] = 0x00F26FA1;
  s21_decimal end_our;
  s21_add(src1, src2, &end_our);
  ck_assert_int_eq(end_origin.bits[3], end_our.bits[3]);
  ck_assert_int_eq(end_origin.bits[2], end_our.bits[2]);
...
START_TEST(s21_sub_1) {
  ...
  s21_set_scale(&check, 2);
  int return_value = s21_sub(value_1, value_2, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
  ck_assert_int_eq(return_value, OK);
}
END_TEST
...
START_TEST(s21_sub_7) {
  ...
  s21_decimal end_origin;
  end_origin.bits[3] = 0b00000000000000110000000000000000;
  end_origin.bits[2] = 0;
  end_origin.bits[1] = 0;
  end_origin.bits[0] = 0b00000000001000111110001111101010;
  s21_decimal end_our;
  s21_sub(src1, src2, &end_our);
  ck_assert_int_eq(end_origin.bits[3], end_our.bits[3]);
  ck_assert_int_eq(end_origin.bits[2], end_our.bits[2]);
  ck_assert_int_eq(end_origin.bits[1], end_our.bits[1]);
  ck_assert_int_eq(end_origin.bits[0], end_our.bits[0]);
...
START_TEST(s21_mul_1) {
  ...
  int return_value = s21_mul(value_1, value_2, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
  ck_assert_int_eq(return_value, OK);
}
END_TEST
...
START_TEST(s21_div_1) {
  ...
  s21_set_scale(&value_1, 1);
  s21_set_scale(&value_2, 2);
  int return_value = s21_div(value_1, value_2, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
  ck_assert_int_eq(return_value, OK);
}
END_TEST
...
START_TEST(s21_div_9) {
  ...
  s21_decimal end_origin;
  end_origin.bits[0] = 0b01000111110000001001001101101011;
  end_origin.bits[1] = 0b10111000000101111000101110100000;
  end_origin.bits[2] = 0b00011010011011010111110000110100;
  end_origin.bits[3] = 0b00000000000110110000000000000000;
  s21_decimal res_od;
  s21_div(src1, src2, &res_od);
  float a, b;
  s21_from_decimal_to_float(end_origin, &a);
...
START_TEST(s21_truncate_3) {
  ...
  end.bits[0] = 0x6DF37F67;
  s21_decimal res_od;
  s21_truncate(src1, &res_od);
  ck_assert_float_eq(res_od.bits[0], end.bits[0]);
  ck_assert_float_eq(res_od.bits[1], end.bits[1]);
  ck_assert_float_eq(res_od.bits[2], end.bits[2]);
  ck_assert_float_eq(res_od.bits[3], end.bits[3]);
}
END_TEST
...
START_TEST(s21_truncate_4) {
  ...
  s21_decimal end;
  end.bits[0] = 0b10000111101111000001011000011110;
  end.bits[1] = 0b00000000000000000000000000000000;
  end.bits[2] = 0b00000000000000000000000000000000;
  end.bits[3] = 0b00000000000000000000000000000000;
  s21_decimal res_od;
  s21_truncate(src1, &res_od);
  ck_assert_float_eq(res_od.bits[0], end.bits[0]);
  ck_assert_float_eq(res_od.bits[1], end.bits[1]);
...
START_TEST(s21_negate_1) {
  ...
  s21_decimal end;
  int return_value = s21_negate(value_1, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
  ck_assert_int_eq(return_value, OK);
}
END_TEST
...
START_TEST(s21_mod_1) {
  ...
  s21_set_scale(&check, 2);
  s21_decimal end;
  int return_value = s21_mod(value_1, value_2, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
  ck_assert_int_eq(return_value, OK);
}
END_TEST
...
START_TEST(s21_round_1) {
  ...
  s21_decimal end;
  int return_value = s21_round(value_1, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
  ck_assert_int_eq(return_value, OK);
}
END_TEST
...
START_TEST(s21_round_5) {
  ...
  s21_decimal end;
  end.bits[0] = 0b00000000000000000000000000000001;
  end.bits[1] = 0b00000000000000000000000000000000;
  end.bits[2] = 0b00000000000000000000000000000000;
  end.bits[3] = 0b10000000000000000000000000000000;
  s21_decimal res_od;
...
START_TEST(s21_round_6) {
  ...
  end.bits[1] = 0b00000000000000000000001000010010;
  end.bits[0] = 0b00110110101101101000110001000000;
  ck_assert_float_eq(res_od.bits[0], end.bits[0]);
  ck_assert_float_eq(res_od.bits[1], end.bits[1]);
  ck_assert_float_eq(res_od.bits[2], end.bits[2]);
  ck_assert_float_eq(res_od.bits[3], end.bits[3]);
...
START_TEST(s21_floor_1) {
  ...
  s21_decimal check = {{74, 0, 0, 0}};
  s21_decimal end;
  int return_value = s21_floor(value_1, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
  ck_assert_int_eq(return_value, OK);
}
END_TEST
...
START_TEST(s21_floor_3) {
  ...
  s21_decimal end;
  end.bits[0] = 0b10100111011001000000000000000000;
  end.bits[1] = 0b00001101111000001011011010110011;
  end.bits[2] = 0b00000000000000000000000000000000;
  end.bits[3] = 0b10000000000000000000000000000000;
  ck_assert_float_eq(res_od.bits[0], end.bits[0]);
  ck_assert_float_eq(res_od.bits[1], end.bits[1]);
...
START_TEST(s21_from_int_to_decimal_1) {
  ...
  s21_decimal end;
  int return_value = s21_from_int_to_decimal(src, &end);
  ck_assert_int_eq(s21_is_equal(end, check), 1);
